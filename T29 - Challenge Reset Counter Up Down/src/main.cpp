...
void setup()
{
  ...
  pinMode(btIncreasePin, INPUT_PULLUP);
  pinMode(btDecreasePin, INPUT_PULLUP);
...
void loop()
{
  ...
  if (btDecreaseState == LOW && btIncreaseState == LOW)
  {
    value = 0;
  }
